...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->savePermission(PermissionConst::GESTION_COMPETENCIA, "Gestión de competencias");
        $this->savePermission(PermissionConst::GESTION_RESULTADO, "Gestión de resultados");
    }
